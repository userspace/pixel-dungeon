...
import space.user.game.dungeon.actors.buffs.FlavourBuff;
...
import space.user.game.dungeon.effects.Wound;
import space.user.game.dungeon.effects.particles.SacrificialParticle;
import space.user.game.dungeon.items.scrolls.ScrollOfWipeOut;
