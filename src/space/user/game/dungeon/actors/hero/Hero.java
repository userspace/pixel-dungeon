 ...
 */
package space.user.game.dungeon.actors.hero;
...
import space.user.game.dungeon.Bones;
import space.user.game.dungeon.Dungeon;
import space.user.game.dungeon.GamesInProgress;
...
import space.user.game.dungeon.actors.buffs.Combo;
import space.user.game.dungeon.actors.buffs.Cripple;
import space.user.game.dungeon.actors.buffs.Fury;
import space.user.game.dungeon.actors.buffs.GasesImmunity;
...
import space.user.game.dungeon.actors.buffs.Ooze;
import space.user.game.dungeon.actors.buffs.Paralysis;
import space.user.game.dungeon.actors.buffs.Poison;
import space.user.game.dungeon.actors.buffs.Regeneration;
import space.user.game.dungeon.actors.buffs.Roots;
import space.user.game.dungeon.actors.buffs.Charm;
import space.user.game.dungeon.actors.buffs.SnipersMark;
import space.user.game.dungeon.actors.buffs.Vertigo;
import space.user.game.dungeon.actors.buffs.Weakness;
import space.user.game.dungeon.actors.mobs.Mob;
import space.user.game.dungeon.actors.mobs.npcs.NPC;
import space.user.game.dungeon.effects.CheckedCell;
import space.user.game.dungeon.effects.Flare;
import space.user.game.dungeon.effects.Speck;
import space.user.game.dungeon.items.Amulet;
...
import space.user.game.dungeon.items.KindOfWeapon;
import space.user.game.dungeon.items.armor.Armor;
import space.user.game.dungeon.items.keys.GoldenKey;
...
import space.user.game.dungeon.items.rings.RingOfAccuracy;
import space.user.game.dungeon.items.rings.RingOfDetection;
import space.user.game.dungeon.items.rings.RingOfElements;
import space.user.game.dungeon.items.rings.RingOfEvasion;
import space.user.game.dungeon.items.rings.RingOfHaste;
import space.user.game.dungeon.items.rings.RingOfShadows;
import space.user.game.dungeon.items.rings.RingOfThorns;
import space.user.game.dungeon.items.scrolls.Scroll;
import space.user.game.dungeon.items.scrolls.ScrollOfMagicMapping;
import space.user.game.dungeon.items.scrolls.ScrollOfRecharging;
...
import space.user.game.dungeon.items.weapon.missiles.MissileWeapon;
import space.user.game.dungeon.levels.Level;
import space.user.game.dungeon.levels.Terrain;
import space.user.game.dungeon.levels.features.AlchemyPot;
import space.user.game.dungeon.levels.features.Chasm;
import space.user.game.dungeon.levels.features.Sign;
import space.user.game.dungeon.plants.Earthroot;
import space.user.game.dungeon.scenes.GameScene;
import space.user.game.dungeon.scenes.InterlevelScene;
import space.user.game.dungeon.scenes.SurfaceScene;
import space.user.game.dungeon.sprites.CharSprite;
import space.user.game.dungeon.sprites.HeroSprite;
import space.user.game.dungeon.ui.AttackIndicator;
import space.user.game.dungeon.ui.BuffIndicator;
import space.user.game.dungeon.utils.GLog;
import space.user.game.dungeon.windows.WndMessage;
import space.user.game.dungeon.windows.WndResurrect;
import space.user.game.dungeon.windows.WndTradeItem;
