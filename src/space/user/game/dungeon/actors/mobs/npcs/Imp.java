...
import space.user.game.dungeon.actors.mobs.Golem;
import space.user.game.dungeon.actors.mobs.Mob;
import space.user.game.dungeon.actors.mobs.Monk;
import space.user.game.dungeon.items.Generator;
import space.user.game.dungeon.items.quest.DwarfToken;
...
import space.user.game.dungeon.sprites.ImpSprite;
import space.user.game.dungeon.utils.Utils;
import space.user.game.dungeon.windows.WndImp;
...
public class Imp extends NPC {
	...
	public static class Quest {
		...
		public static void storeInBundle( Bundle bundle ) {
			...
			Bundle node = Bundle.read("NPC_IMP");
