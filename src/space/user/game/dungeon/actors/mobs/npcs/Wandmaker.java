 ...
 */
package space.user.game.dungeon.actors.mobs.npcs;
...
import space.user.game.dungeon.items.quest.CorpseDust;
import space.user.game.dungeon.items.quest.PhantomFish;
import space.user.game.dungeon.items.wands.Wand;
import space.user.game.dungeon.items.wands.WandOfAmok;
import space.user.game.dungeon.items.wands.WandOfAvalanche;
import space.user.game.dungeon.items.wands.WandOfBlink;
import space.user.game.dungeon.items.wands.WandOfDisintegration;
import space.user.game.dungeon.items.wands.WandOfFirebolt;
import space.user.game.dungeon.items.wands.WandOfLightning;
import space.user.game.dungeon.items.wands.WandOfPoison;
import space.user.game.dungeon.items.wands.WandOfRegrowth;
import space.user.game.dungeon.items.wands.WandOfSlowness;
import space.user.game.dungeon.items.wands.WandOfReach;
...
import space.user.game.dungeon.plants.Rotberry;
import space.user.game.dungeon.scenes.GameScene;
import space.user.game.dungeon.sprites.WandmakerSprite;
import space.user.game.dungeon.utils.Utils;
import space.user.game.dungeon.windows.WndQuest;
import space.user.game.dungeon.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
	...
	public static class Quest {
		...
		public static void storeInBundle( Bundle bundle ) {
			...
			Bundle node = Bundle.read("NPC_WANDMAKER");
