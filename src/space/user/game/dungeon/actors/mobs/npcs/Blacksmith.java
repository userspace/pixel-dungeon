...
import space.user.game.dungeon.items.EquipableItem;
import space.user.game.dungeon.items.Item;
import space.user.game.dungeon.items.quest.DarkGold;
import space.user.game.dungeon.items.quest.Pickaxe;
import space.user.game.dungeon.items.scrolls.ScrollOfUpgrade;
import space.user.game.dungeon.levels.Room;
import space.user.game.dungeon.levels.Room.Type;
import space.user.game.dungeon.scenes.GameScene;
import space.user.game.dungeon.sprites.BlacksmithSprite;
import space.user.game.dungeon.utils.GLog;
import space.user.game.dungeon.windows.WndBlacksmith;
...
public class Blacksmith extends NPC {
	...
	public static class Quest {
		...
		public static void storeInBundle( Bundle bundle ) {
			...
			Bundle node = Bundle.read("NPC_BLACKSMITH");
