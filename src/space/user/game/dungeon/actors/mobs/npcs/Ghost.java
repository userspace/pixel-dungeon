...
import space.user.game.dungeon.actors.mobs.CursePersonification;
import space.user.game.dungeon.actors.mobs.FetidRat;
...
import space.user.game.dungeon.effects.particles.ShadowParticle;
...
import space.user.game.dungeon.items.quest.DriedRose;
import space.user.game.dungeon.items.quest.RatSkull;
...
import space.user.game.dungeon.sprites.GhostSprite;
import space.user.game.dungeon.utils.Utils;
import space.user.game.dungeon.windows.WndQuest;
import space.user.game.dungeon.windows.WndSadGhost;
...
public class Ghost extends NPC {
	...
	public static class Quest {
		...
		public static void storeInBundle( Bundle bundle ) {
			...
			Bundle node = Bundle.read("NPC_GHOST");
