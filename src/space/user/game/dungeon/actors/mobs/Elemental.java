...
import space.user.game.dungeon.items.potions.PotionOfLiquidFlame;
...
import space.user.game.dungeon.items.weapon.enchantments.Fire;
import space.user.game.dungeon.sprites.ElementalSprite;
