...
import space.user.game.dungeon.effects.Pushing;
...
import space.user.game.dungeon.sprites.BurningFistSprite;
import space.user.game.dungeon.sprites.CharSprite;
import space.user.game.dungeon.sprites.LarvaSprite;
import space.user.game.dungeon.sprites.RottingFistSprite;
import space.user.game.dungeon.sprites.YogSprite;
