...
import space.user.game.dungeon.Rankings;
import space.user.game.dungeon.RankingsRecord;
...
import space.user.game.dungeon.windows.WndError;
import space.user.game.dungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			for (RankingsRecord rec : Rankings.INSTANCE.records) {
	...
	public static class Record extends Button {
		...
		public Record( int pos, boolean latest, RankingsRecord rec ) {
			super();
