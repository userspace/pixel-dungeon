...
import space.user.game.dungeon.actors.mobs.Acidic;
import space.user.game.dungeon.actors.mobs.Albino;
import space.user.game.dungeon.actors.mobs.Bandit;
import space.user.game.dungeon.actors.mobs.Mob;
import space.user.game.dungeon.actors.mobs.Senior;
import space.user.game.dungeon.actors.mobs.Shielded;
...
import space.user.game.dungeon.items.rings.RingOfHaggler;
...
public class Badges {
	...
	private static final String BADGES_FILE	= "BADGES_GLOBAL";
	...
	public static void loadGlobal() {
		if (global == null) {
			try {
				Bundle bundle = Bundle.read( BADGES_FILE );
	...
	public static void saveGlobal() {
		...
		if (saveNeeded) {
			...
			bundle = Bundle.read(BADGES_FILE);
			store( bundle, global );
