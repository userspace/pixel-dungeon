...
import space.user.game.dungeon.items.food.MysteryMeat;
import space.user.game.dungeon.items.food.Pasty;
import space.user.game.dungeon.items.potions.*;
import space.user.game.dungeon.items.rings.*;
import space.user.game.dungeon.items.scrolls.*;
import space.user.game.dungeon.items.wands.*;
import space.user.game.dungeon.items.weapon.*;
import space.user.game.dungeon.items.weapon.melee.*;
import space.user.game.dungeon.items.weapon.missiles.*;
import space.user.game.dungeon.plants.*;
