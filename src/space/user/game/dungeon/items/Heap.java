...
import space.user.game.dungeon.actors.mobs.Wraith;
...
import space.user.game.dungeon.items.food.ChargrilledMeat;
import space.user.game.dungeon.items.food.FrozenCarpaccio;
