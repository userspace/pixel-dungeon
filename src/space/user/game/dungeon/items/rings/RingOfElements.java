...
import space.user.game.dungeon.actors.mobs.Eye;
import space.user.game.dungeon.actors.mobs.Warlock;
import space.user.game.dungeon.actors.mobs.Yog;
import space.user.game.dungeon.levels.traps.LightningTrap;
