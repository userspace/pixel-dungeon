...
import space.user.game.dungeon.actors.mobs.npcs.ImpShopkeeper;
import space.user.game.dungeon.actors.mobs.npcs.Shopkeeper;
...
import space.user.game.dungeon.items.Torch;
import space.user.game.dungeon.items.Weightstone;
import space.user.game.dungeon.items.armor.*;
import space.user.game.dungeon.items.bags.ScrollHolder;
import space.user.game.dungeon.items.bags.SeedPouch;
import space.user.game.dungeon.items.bags.WandHolster;
import space.user.game.dungeon.items.food.OverpricedRation;
...
import space.user.game.dungeon.items.scrolls.ScrollOfRemoveCurse;
import space.user.game.dungeon.items.weapon.melee.*;
