 ...
 */
package space.user.game.dungeon.effects;

import space.user.game.noosa.Game;
import space.user.game.noosa.Group;
import space.user.game.noosa.particles.Emitter;
import space.user.game.noosa.particles.PixelParticle;
import space.user.game.noosa.particles.PixelParticle.Shrinking;
...
import space.user.game.dungeon.effects.particles.PurpleParticle;
import space.user.game.dungeon.effects.particles.ShadowParticle;
import space.user.game.dungeon.effects.particles.WoolParticle;
import space.user.game.utils.Callback;
import space.user.game.utils.ColorMath;
import space.user.game.utils.PointF;
